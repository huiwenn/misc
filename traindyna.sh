...
python scripts/train_dynamics.py --dataset_path ../argoverse_data --rho-reg --batch_size 32 --val_batch_size 8 --use_lane --train --model_name dyna_mis_naut --batches_per_epoch 1200 --val_batches 50 --epochs 100 --loss mis
