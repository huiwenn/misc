...
python scripts/ped_train_dyna.py --dataset_path ../pedestrian --rho-reg --batch_size 8 --batch_divide 2 --val_batch_size 8 --model_name new_ped_dyna --batches_per_epoch 300 --val_batches 10 --epochs 100 --loss nll --train
